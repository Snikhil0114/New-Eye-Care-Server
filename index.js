...
//   // POST /sales - Save a new sale
// app.post('shala/sales', (req, res) => {
//   const saleId = uuidv4(); // Generate a unique sale ID
//   const { customer_id, customer_phone, product_id, sale_price, quantity, payment_method, order_discount, paid } = req.body;
//   const branch = 1; // Assuming you're handling branches

//   // Calculate item total (sale_price * quantity)
//   const itemTotal = sale_price * quantity;

//   // Insert sale into the sales table
//   const query = `INSERT INTO sales (branch,sale_id, customer_id, customer_phone, product_id, sale_price, quantity, item_total, payment_method, order_discount, paid) 
//                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
//   const values = [branch,saleId, customer_id, customer_phone, product_id, sale_price, quantity, itemTotal, payment_method, order_discount, paid];
...
//     // Return the sale ID after successful insertion
//     res.status(200).json({ message: 'Sale saved successfully.', sale_id: saleId });
//   });
// });

// GET /sales/:id - Fetch sale data by sale ID
app.get('/bill/sales/sale_id', (req, res) => {
...
app.get('/wala/shala/saledet/sale_id', (req, res) => {
